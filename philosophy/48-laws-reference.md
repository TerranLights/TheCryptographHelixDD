# 48 Laws of Power — Reference

Full list of Robert Greene's 48 Laws of Power, used as a framework for characterizing each faction's behavior. For faction-specific applications, see each faction's `48-laws.md` file.
...
**Law 45: Preach the Need for Change, but Never Reform too Much at Once** — Everyone understands the need for change in the abstract, but on the day-to-day level people are creatures of habit and will resist it. Too much innovation is traumatic, and will lead to revolt.
